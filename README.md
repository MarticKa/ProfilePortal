...
Fork this repository, implement your solution in the fork, and submit the fork.

### What to cover

Choose scenarios at your own discretion — from critical paths to lower-priority ones — but keep the scope realistic for the time limit. We do not expect full coverage.

The mix of UI, API, and E2E tests is up to you. Pick what makes sense for each scenario and aligns with common QA automation best practices.

One browser is enough; the default setup uses Chromium.

Feel free to adjust the Playwright setup — config, folder structure, helpers, fixtures, and npm scripts — if that fits your approach.

### Please include

- a short README explaining selected scenarios, assumptions, and what you would add with more time

### Notes

- If anything is unclear, ask.
- If you run into a problem or suspect a bug in the application, document it (what you did, what you expected, what happened).

Focus on scenario selection, test architecture, data handling, and API usage.